...
export class TopicsService {
  ...
  public topics: TagEntry[] = this.transformTags([
   ...
   materialDesign, typeScript,
    ...
    'Markdown',
    tag('English Language', 'english'),
    tag('Spanish Language', 'spanish'),
    tag('French Language', 'french'),
    tag('Portuguese Language', 'portuguese'),
    tag('German Language', 'german'),
    tag('Italian Language', 'italian'),
    tag('Polish Language', 'polish'),
    tag('Russian Language', 'russian'),
    tag('Chinese Language', 'chinese'),
    tag('Japanese Language', 'japanese'),
    tag('Arabic Language', 'arabic'),
    tag('Hindi Language', 'hindi'),
    tag('Turkish Language', 'turkish'),
