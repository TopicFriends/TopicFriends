...
export class TopicsService {
  ...
  public topics: TagEntry[] = this.transformTags([
    ...
    tagNoIcon('NoSQL'), 'PostgreSQL', 'MySQL',
    ...
    tag('Fedora', 'fedora'), 'CentOS', tagNoIcon('Gentoo Linux'), tag('Arch Linux', 'archlinux'),
    'FreeBSD',
    'Redis', 'CouchBase', 'CouchDB', 'MongoDB', 'Memcached',
    'PrestaShop', 'WooCommerce', tagNoIcon('osCommerce'), 'Magento',
    tagLogoTipo('Lucene'), 'Solr',
    tag('macOS', 'macosx'),
    'Kinto',
    'KickStarter',
    'Lua',
