...
export const topics = [
  ...
  tag('Surfing', 'generic/fun/person-surfing-svgrepo-com.svg'),
  tagNoIcon('Stand up paddleboarding'),
  tag('Windsurfing', 'generic/fun/man-windsurfing-svgrepo-com.svg'),
  tag('Kitesurfing', 'generic/fun/kitesurfing-svgrepo-com.svg'),
  tagNoIcon('Paragliding'),
  tag('Cooking', 'generic/fun/chef-cooking-on-stove-svgrepo-com.svg'),
  tag('Business Lunch', 'generic/fun/business-meeting-svgrepo-com.svg'),
  tag('Mountain Climbing', 'generic/fun/snowy-mountains-svgrepo-com.svg'),
  tag('Camping', 'generic/fun/camping-svgrepo-com.svg'),
  tag('Digital Nomading', 'generic/fun/laptop-svgrepo-com.svg'),
  tag('Video Games', 'generic/fun/video-games-game-controller-svgrepo-com.svg'),
  tag('Plant Parent', 'generic/fun/plants-pots-svgrepo-com.svg'),
  tag('Gardening', 'generic/fun/green-construction-gardening-planting-farming-svgrepo-com.svg'),
  tag('Social Dance', 'generic/fun/dancing-svgrepo-com.svg'),
  tagNoIcon('CouchSurfing'),
  tagNoIcon('Nomading'),
  tag('Chilling', 'generic/fun/sit-down-couch-svgrepo-com.svg'),
  tag('Beach Day', 'generic/fun/person-lying-on-a-beach-under-an-umbrella-svgrepo-com.svg'),
  tagNoIcon('Tinkering/Mechanics'),
  tag('Nordic Walking', 'generic/fun/skiing-nordic-solid-svgrepo-com.svg'),
  tag('Jogging', 'generic/fun/one-man-walking-svgrepo-com.svg'),
  tag('Martial Arts', 'generic/fun/man-practicing-martial-arts-svgrepo-com.svg'),
  tag('Craft Beer', 'generic/fun/beer-svgrepo-com.svg'),
  tag('Craft Brewery', 'generic/fun/beer-svgrepo-com.svg'),
  tag('Live Sport', 'generic/fun/football-game-field-top-view-svgrepo-com.svg'),
  ...
  tag('Hip-Hop Music', 'generic/fun/music-svgrepo-com.svg'),
  tag('Rock Music', 'generic/fun/heavy-metal-concert-svgrepo-com.svg'),
  tag('Frisbee', 'generic/fun/play-frisbee-svgrepo-com.svg'),
  tag('Rock Climbing', 'generic/fun/person-standing-on-top-of-a-mountain-svgrepo-com.svg'),
  tag('Indoor Climbing', 'generic/fun/rock-climbing-svgrepo-com.svg'),
  tag('Climbing Wall', 'generic/fun/rock-climbing-svgrepo-com.svg'),
  tag('Electronics', 'generic/fun/wellness-gadget-technology-device-equipment-innovation-electronic-svgrepo-com.svg'),
]